define([
    ...
    return {
        ...
        parseBet: function (betString) {
            ...
            if (bet < 0.000001)
                return new Error('The bet should be at least 0.000001 CLAM');

            if (bet  > AppConstants.Engine.MAX_BET)
                return new Error('The bet must be less no more than ' + formatSatoshis(AppConstants.Engine.MAX_BET) + ' CLAM');
