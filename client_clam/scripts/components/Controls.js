define([
    ...
    return React.createClass({
        ...
        _placeBet: function () {
            var bet = parseFloat(Math.round(this.state.betSize * 1e8));
        ...
        _invalidBet: function () {
            ...
            if (self.state.engine.userBalance < 100)
                return 'Not enough CLAM to play';

            if (self.state.maxWin < 1)
                return 'Not enough CLAM Bankroll to play';
            ...
            if (self.state.engine.userBalance < bet * Math.pow(10, 8))
                return 'Not enough CLAM';
        ...
        _getBetter: function () {
          ...
          var betInput = D.div(null,
              ...
              D.div({ className: 'input-wrapper'},
                ...
                D.span({ className: 'bet-unit'}, 'CLAM')
              )
          );
        ...
        _getContents: function() {
          ...
          } else if ((this.state.engine.maxWin > 0)){ // user can place a bet
