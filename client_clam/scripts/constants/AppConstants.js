define(['lib/key-mirror'], function(KeyMirror){
    ...
    var host = 'https://games.freebitcoins.com:3842/';
    ...
    return {
        ...
        Engine: {
            ...
            HOST: host,
            //MAX_BET: 10 * Math.pow(10,8) /** Max bet per game 10 CLAM, this will be calculated dynamically in the future, based on the invested amount in the casino **/
        },
