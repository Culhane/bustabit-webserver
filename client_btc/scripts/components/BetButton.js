        ...
        render: function() {
            ...
            if (this.props.engine.isBetting()) {
              ...
              if(bet) //If the bet is queued
                  bet = Clib.formatSatoshis(bet, 6) + ' BTC';
              ...
              return D.div({ className: 'cash-out' },
                ...
                if (invalidBet || this.props.engine.placingBet) {
                    return D.a({ className: 'bet-btn button orange disable' }, 'Bet BTC!');
                } else {
                    button = D.a({ className: 'bet-btn button orange', onClick: self.props.placeBet }, 'Bet BTC!');
                    return D.div(null,
                        button,
