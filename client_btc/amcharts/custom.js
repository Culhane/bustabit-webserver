    ...
    AmCharts.ready(function () {
        ...
        function frmt(x) {
            ...
            var r = "<table>" +
                ...
                "</td></tr>" +
                '<tr><th>Bet:</th><td>' + (entry.bet/Math.pow(10,14)).toFixed(8) + ' CLAM</td></tr>' +
                "<tr><th>Crash At:</th><td>" + (typeof entry.game_crash !== 'undefined' ? (entry.game_crash/100).toFixed(2) + 'x' : '?') + "</td></tr>" +
                "<tr><th>Cashed Out:</th><td>" + (entry.cash_out ? ((entry.cash_out) / (entry.bet/Math.pow(10,6))).toFixed(2) + 'x' : '-') + "</td></tr>" +                "<tr><th>Profit:</th><td><b>" + (profit/Math.pow(10,8)).toFixed(8) + " CLAM</b></td></tr>" +
                '</table>';
            return r;
